...
<!-- <li><i class="ion-android-checkmark-circle"></i> Create synergies </li>               
 -->              <li> Finding easily georeferenced data-sets linked to research themes </li>
		    ...
		    ============================-->
   			...
   			A complete catalag here: <a href="map_catalog.php">Link</a>
...
<!--             <div class="col-lg-5 col-md-6">
    ...
    <div class="container">
        <div class="row">
          ...
          <h3>WP4</h3>
<!--         <p>
          <strong>WP4 </strong>aims at disseminating the gained knowledge across all communities (<em>Goal 5</em>). We plan four deliverables:</p> -->
          <ul>
...
<!--       </section>
 -->
      <!-- <section id="wp2" class="section-bg">
        <p><strong>WP2 </strong>deals with the coupling between subsurface and surface observation (including remotely), acquired via geophysical monitoring (arising from the methodology developed during the WP1) and plant physiology and atmospheric measurements. WP2 will provide results for three deliverables:</p>
        <ul>
      ...
      <section id="wp3" class="section-bg">
         <strong>WP3</strong> deals with data assimilation (DA) of geophysical information into hydrogeophysical modelling (<em>Goal 3</em>) for the identification of active root zones. WP1 and WP2 outputs will serve as inputs. One deliverable is expected:</p>
        <ul>
...
<!--              <div class="form">
 -->              
              <h4><a href="mailto:benjamin.mary@unipd.it?subject=Question MSCA GROWING"> Click here to send us an email! </a></h4>
